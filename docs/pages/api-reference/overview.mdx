...
| **Marketplace**      | browse, featured, reviews, submit, admin approval (plugins + themes)          |
| **Model Configs**    | `GET /model-configs`, `POST /model-configs`, versioning, A/B test             |
...
| **Plugin Endpoints** | `ALL /plugins/:pluginId/endpoints/*` (dynamic plugin routes)                  |
